function change_detection_kuwait(path)
%CHANGE_DETECTION_KUWAIT Summary of this function goes here
...
for i = 1:Nfile
    ...
    if i == 1
        ...
        filename = [dif_name, '_Kuwait.jpg'];
        imwrite(I1, ['processedData/',filename]);
    else
        k = D{P};
        %Rotate picture using the preprocess function
        I2_prepro = preprocessing_basic(ref,k);
        %Overlay processed and reference image
        c = imfuse(ref, I2_prepro, "ColorChannels","red");
